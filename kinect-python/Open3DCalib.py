...
if __name__ == "__main__":
    ...
    #pinhole_camera_intrinsic = o3d.io.read_pinhole_camera_intrinsic("Ex.json")
    #pinhole_camera_intrinsic = o3d.io.read_pinhole_camera_intrinsic("Semi-T-Grid1.json")
    pinhole_camera_intrinsic = o3d.io.read_pinhole_camera_intrinsic("nothing.json")
    #pinhole_camera_intrinsic = o3d.io.read_pinhole_camera_intrinsic("IntrinsicParameters.dat")
   ...
   #depth = cv2.cvtColor(depth,cv2.COLOR_GRAY2RGB)
    ...
    depth[depth>400] = 0  #clear the points above 350 cm
    ...
    rgbd_image = o3d.geometry.RGBDImage.create_from_color_and_depth(RGB, D,convert_rgb_to_intensity=False)
