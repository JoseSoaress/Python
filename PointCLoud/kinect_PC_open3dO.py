...
if __name__ == "__main__":
   ...
   # Flip it, otherwise the pointcloud will be upside down 
    ...
    while 1:
        ...
        #rgbd_image = o3d.geometry.RGBDImage.create_from_nyu_format(RGB, D, convert_rgb_to_intensity=False)
        #rgbd_image = o3d.geometry.RGBDImage.create_from_sun_format(RGB, D, convert_rgb_to_intensity=False)#first 2 don't have good results
        
        #rgbd_image = o3d.geometry.RGBDImage.create_from_tum_format(RGB, D, convert_rgb_to_intensity=False)
